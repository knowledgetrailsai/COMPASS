...
Where state AI laws exist or are proposed, common themes include:
- Consumer notice when interacting with AI or when AI materially influences a consequential decision (employment, credit, housing, insurance, healthcare)
- Impact assessment obligations for "high-risk" automated decision systems
- Anti-discrimination requirements specific to algorithmic decision-making
- Deepfake/synthetic media disclosure requirements (a distinct, more stable category — several states have specific deepfake laws, particularly around elections and non-consensual intimate imagery, that are less caught up in the AI-Act-style federal tension)
