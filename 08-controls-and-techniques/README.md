...
**Test**: how you verify the control/technique actually works ([04-ai-assurance](../04-ai-assurance/)).
...
| Folder/file | Covers |
|---|---|
| [fairness-testing/](fairness-testing/) | Bias metrics, mitigation techniques |
| [explainability/](explainability/) | Feature attribution, counterfactuals, interpretability methods |
| [privacy-techniques/](privacy-techniques/) | Differential privacy, federated learning, anonymization, PII handling |
| [robustness-testing/](robustness-testing/) | Adversarial testing, stress testing |
| [evaluation-and-benchmarking/](evaluation-and-benchmarking/) | Evaluation methodology and benchmark design |
| [monitoring-and-observability/](monitoring-and-observability/) | Production monitoring techniques |
| [guardrails-and-controls.md](guardrails-and-controls.md) | Runtime content/action controls |

Each technique file links back to the risk(s) it mitigates and the tool(s) that implement it in [09-tools-and-frameworks](../09-tools-and-frameworks/).
