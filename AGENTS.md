...
Compass is the responsible AI, security and governance companion implementing OASIS Chapters 19 and 20.
...
This repo is one of ten in the knowledgetrailsai OASIS ecosystem: OASIS, Ageis, Forge, Loom, Helm, Verity, Fulcrum. When you add a cross-repo link, use the exact repository name and default branch; they are not uniform:
